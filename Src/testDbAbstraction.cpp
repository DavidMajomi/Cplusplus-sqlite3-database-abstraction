...
const string DATABASE_NAME_WITH_PATH = CURRENT_FULL_PATH + "//Databases//bam_bam.db";       // Has to be a constant char to be compatibe with sqlite
...
void addData()
{
    ...
    int creditScore = 850;
    vector <vector <pair <string, string>>> dataToAdd;
    vector <pair <string, string>> temp (21);
